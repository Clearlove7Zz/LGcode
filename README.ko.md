...
LGcode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/Clearlove7Zz/LGcode/releases) 에서 직접 다운로드하거나 [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download) 를 이용하세요.
...
LGcode 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
LGcode 설정에 대한 자세한 내용은 [**문서**](https://modelhub.lgdg.cc/docs) 를 참고하세요.

### 기여하기

LGcode 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.
