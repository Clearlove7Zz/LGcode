...
nix run nixpkgs#loongcode           # ή github:Clearlove7Zz/LGcode με βάση την πιο πρόσφατη αλλαγή από το dev branch
```
...
Το Loongcode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/Clearlove7Zz/LGcode/releases) ή το [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download).
