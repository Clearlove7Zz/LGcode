...
brew install Clearlove7Zz/tap/loongcode # macOS og Linux (anbefalt, alltid oppdatert)
...
Loongcode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/Clearlove7Zz/LoongCode/releases) eller [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download).
...
Les mer om [agents](https://modelhub.lgdg.cc/docs/agents).
