...
- Keep product naming consistent: `LGcode` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `LGcode` inside commands, URLs, package names, or code literals
