...
Generates UPCOMING_CHANGELOG.md by running the loongcode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for loongcode run (default: low)
      --quiet            Suppress loongcode command output unless it fails
