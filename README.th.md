...
nix run nixpkgs#loongcode           # หรือ github:Clearlove7Zz/LGcode สำหรับสาขาพัฒนาล่าสุด
```
...
Loongcode มีให้ใช้งานเป็นแอปพลิเคชันเดสก์ท็อป ดาวน์โหลดโดยตรงจาก [หน้ารุ่น](https://github.com/Clearlove7Zz/LGcode/releases) หรือ [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download)
