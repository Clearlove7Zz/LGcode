...
LGcode はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/opencode/releases) から直接ダウンロードするか、[modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download) を利用してください。
