...
@lgcode/@lgcode/ https:@lgcode/@lgcode/icones.js.org@lgcode/collection@lgcode/ri?s=openai&icon=ri:openai-fill
export function IconOpenAI(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg {...props} xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg" viewBox="0 0 24 24">
      <path
        fill="currentColor"
...
@lgcode/@lgcode/ https:@lgcode/@lgcode/icones.js.org@lgcode/collection@lgcode/ri?s=anthropic&icon=ri:anthropic-fill
...
@lgcode/@lgcode/ https:@lgcode/@lgcode/icones.js.org@lgcode/collection@lgcode/ri?s=gemini&icon=ri:gemini-fill
...
export function IconOpencode(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 70 70" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        ...
        fill="currentColor"
      @lgcode/>
      <path d="M43.75 13H70V22.1957H52.5V48.701H70V57.8967H43.75V13Z" fill="currentColor" @lgcode/>
    <@lgcode/svg>
  )
}

@lgcode/@lgcode/ https:@lgcode/@lgcode/icones.js.org@lgcode/collection@lgcode/ri?s=meta&icon=ri:meta-fill
...
@lgcode/@lgcode/ https:@lgcode/@lgcode/icones.js.org@lgcode/collection@lgcode/ri?s=robot&icon=ri:robot-2-line
...
@lgcode/@lgcode/ https:@lgcode/@lgcode/icones.js.org@lgcode/collection@lgcode/ri?s=brain&icon=ri:brain-2-line
