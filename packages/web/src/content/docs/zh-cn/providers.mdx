...
1. 在 TUI 中执行 `/connect` 命令，选择 opencode，然后前往 [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth)。
...
:::tip
Ollama 可以自动为 LGcode 进行配置。详见 [Ollama 集成文档](https://docs.ollama.com/integrations/opencode)。
:::
