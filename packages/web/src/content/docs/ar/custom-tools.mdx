...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في lgcode.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في lgcode مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.lgcode/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/lgcode/tools/`.
