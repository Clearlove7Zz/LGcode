---
title: TUI
description: استخدام واجهة المستخدم TUI في Loongcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Loongcode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Loongcode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Loongcode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Loongcode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Loongcode. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `loongcode.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Loongcode بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `loongcode.default`.
