...
يمكنك تحديد ملفات تعليمات مخصصة في `lgcode.json` أو في الملف العام `~/.config/opencode/lgcode.json`. يتيح ذلك لك ولفريقك إعادة استخدام القواعد الموجودة بدلًا من تكرارها داخل AGENTS.md.
