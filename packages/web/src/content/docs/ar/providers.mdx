...
1. شغّل الأمر `/connect` في TUI، واختر opencode، ثم انتقل إلى [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
:::tip
يمكن لـ Ollama ضبط نفسه تلقائيا للعمل مع LGcode. راجع [توثيق تكامل Ollama](https://docs.ollama.com/integrations/opencode) للتفاصيل.
:::
