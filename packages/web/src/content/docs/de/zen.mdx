...
Die [Model-ID](/docs/config/#models) in deiner LGcode-Konfiguration verwendet das Format `lgcode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `lgcode/gpt-5.5` in deiner Konfiguration verwenden.
