...
Hier ist der vollständige ID `provider_id/model_id`. Wenn Sie beispielsweise [LGcode Zen](/docs/zen) verwenden, würden Sie `lgcode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
