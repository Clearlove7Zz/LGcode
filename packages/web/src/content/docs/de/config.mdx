...
Platzieren Sie Ihre globale OpenCode-Konfiguration in `~/.config/opencode/lgcode.json`. Verwenden Sie die globale Konfiguration für benutzerweite Einstellungen wie Themen, Anbieter oder Tastenkombinationen.
