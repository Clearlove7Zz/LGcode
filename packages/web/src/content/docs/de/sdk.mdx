---
title: SDK
description: Typsicherer JS-Client fuer den loongcode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das loongcode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und loongcode programmatisch steuern.
...
Erstelle eine loongcode-Instanz:
...
`loongcode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn loongcode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
