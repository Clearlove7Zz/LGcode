...
- **macOS/Linux**: `~/.config/opencode/lgcode.jsonc` (oder `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (aeltere Installationen): `~/.local/share/opencode/lgcode.jsonc`
- **Windows**: Druecke `WIN+R` und fuege ein: `%USERPROFILE%\.config\opencode\lgcode.jsonc`
