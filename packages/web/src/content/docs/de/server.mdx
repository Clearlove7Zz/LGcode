...
Der Benutzername ist standardmaessig `opencode`, kann aber mit `LGCODE_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `lgcode serve` und `lgcode web`.
...
:::tip
Nutze den lgcode-Server, um opencode programmatisch anzusteuern.
:::
