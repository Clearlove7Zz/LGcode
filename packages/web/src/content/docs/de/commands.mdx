...
Erstellen Sie `.lgcode/commands/test.md`:

```md title=".lgcode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die LGcode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem LGcode [config](/docs/config):

```json title="lgcode.jsonc" {4-12}
{
...
- Global: `~/.config/lgcode/commands/`
- Pro Projekt: `.lgcode/commands/`

```markdown title="~/.config/lgcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".lgcode/commands/component.md"
---
...
```md title=".lgcode/commands/create-file.md"
---
...
```md title=".lgcode/commands/analyze-coverage.md"
---
...
```md title=".lgcode/commands/review-changes.md"
---
...
```md title=".lgcode/commands/review-component.md"
---
...
LGcode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
