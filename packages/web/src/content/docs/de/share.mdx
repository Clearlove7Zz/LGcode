---
title: Teilen
description: Teile LGcode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu LGcode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht LGcode Folgendes:
...
LGcode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt LGcode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`lgcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du lgcode in deiner Organisation einsetzt.
