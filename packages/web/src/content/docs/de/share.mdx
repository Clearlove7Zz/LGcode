---
title: Teilen
description: Teile Loongcode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Loongcode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Loongcode Folgendes:
...
Loongcode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Loongcode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`loongcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du loongcode in deiner Organisation einsetzt.
