...
Ici, l'identifiant complet est `provider_id/model_id`. Par exemple, si vous utilisez [LGcode Zen](/docs/zen), vous utiliserez `lgcode/gpt-5.1-codex` pour GPT 5.1 Codex.
