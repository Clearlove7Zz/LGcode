...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez opencode et dirigez-vous vers [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
:::tip
Ollama peut se configurer automatiquement pour LGcode. Voir les [documents d'intégration Ollama](https://docs.ollama.com/integrations/opencode) pour plus de détails.
:::
