...
Le [model id](/docs/config/#models) dans votre configuration LGcode utilise le format `lgcode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `lgcode/gpt-5.5` dans votre configuration.
