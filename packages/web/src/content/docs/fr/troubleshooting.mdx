...
- **macOS/Linux** : `~/.config/opencode/lgcode.jsonc` (ou `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (anciennes installations) : `~/.local/share/opencode/lgcode.jsonc`
- **Windows** : appuyez sur `WIN+R` et collez `%USERPROFILE%\.config\opencode\lgcode.jsonc`
