...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
Вот [пример диалога](https://modelhub.lgdg.cc/s/4XP1fce5) с opencode.
