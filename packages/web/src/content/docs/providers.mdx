...
```jsonc title="~/.config/opencode/lgcode.jsonc"
{
  "$schema": "https://modelhub.lgdg.cc/config.json",
  "provider": {
    "helicone": {
...
:::tip
Ollama can automatically configure itself for LGcode. See the [Ollama integration docs](https://docs.ollama.com/integrations/opencode) for details.
:::
