...
- **macOS/Linux**: `~/.config/opencode/lgcode.jsonc` (または `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (古いインストール): `~/.local/share/opencode/lgcode.jsonc`
- **Windows**: `WIN+R` を押して `%USERPROFILE%\.config\opencode\lgcode.jsonc` を貼り付けます
