---
title: IDE
description: The LGcode extension for VS Code, Cursor, and other IDEs
---

LGcode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `lgcode` in the terminal to get started.
...
To install LGcode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `lgcode` - the extension installs automatically
...
Search for **LGcode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `lgcode` in the integrated terminal.
