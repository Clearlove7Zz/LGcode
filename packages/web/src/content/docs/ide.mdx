---
title: IDE
description: The Loongcode extension for VS Code, Cursor, and other IDEs
---

Loongcode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `loongcode` in the terminal to get started.
...
To install Loongcode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `loongcode` - the extension installs automatically
...
Search for **Loongcode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `loongcode` in the integrated terminal.
