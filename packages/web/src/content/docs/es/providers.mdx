...
1. Ejecute el comando `/connect` en TUI, seleccione opencode y diríjase a [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
:::tip
Ollama puede configurarse automáticamente para LGcode. Consulte los [documentos de integración de Ollama](https://docs.ollama.com/integrations/opencode) para obtener más detalles.
:::
