...
Puede agregar comandos personalizados a través de la configuración LGcode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su LGcode [config](/docs/config):
...
lgcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
