...
Crear `.loongcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Loongcode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Loongcode [config](/docs/config):
...
- Por proyecto: `.loongcode/commands/`
...
loongcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
