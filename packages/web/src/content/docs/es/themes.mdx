...
Con Loongcode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Loongcode usa nuestro propio tema `loongcode`.
...
Loongcode viene con varios temas integrados.
...
- Quiere que Loongcode coincida con la apariencia de su terminal
...
Loongcode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/loongcode/themes/*.json` o `$XDG_CONFIG_HOME/loongcode/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.loongcode/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.loongcode/themes/*.json`
