...
- **macOS/Linux**: `~/.config/opencode/lgcode.jsonc` (o `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (instalaciones anteriores): `~/.local/share/opencode/lgcode.jsonc`
- **Windows**: Presione `WIN+R` y pegue `%USERPROFILE%\.config\opencode\lgcode.jsonc`
