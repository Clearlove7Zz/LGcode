...
El ID del modelo en su configuración LGcode usa el formato `provider/model-id`. Por ejemplo, si usa [LGcode Zen](/docs/zen), usaría `opencode/gpt-5.1-codex` para GPT 5.1 Codex.
