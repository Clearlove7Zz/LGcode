...
Puede especificar archivos de instrucciones personalizados en su `lgcode.json` o el `~/.config/opencode/lgcode.json` global. Esto le permite a usted y a su equipo reutilizar las reglas existentes en lugar de tener que duplicarlas en AGENTS.md.
