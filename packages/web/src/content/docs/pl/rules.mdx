...
Możesz określić niestandardowe pliki instrukcji w swoim `lgcode.json` lub globalnym `~/.config/opencode/lgcode.json`. Dzięki temu Ty i Twój zespół możecie ponownie wykorzystać istniejące reguły, zamiast duplikować je w pliku AGENTS.md.
