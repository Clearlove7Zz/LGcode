...
LGcode Zen to lista modeli dostarczonych przez zespół opencode, które zostały
...
LGcode Go to tani plan subskrypcji, który zapewnia niezawodny dostęp do popularnych modeli open coding dostarczanych przez zespół opencode, które zostały przetestowane i zweryfikowane pod kątem dobrej współpracy z opencode.
...
Funkcja [Sesje](https://docs.helicone.ai/features/sessions) firmy Helicone umożliwia grupowanie powiązanych żądań LLM. Użyj wtyczki [lgcode-helicone-session](https://github.com/H2Shami/lgcode-helicone-session), aby automatycznie rejestrować każdą konwersację opencode jako sesję w Helicone.
...
LGcode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół opencode. [Dowiedz się więcej](/docs/zen).
