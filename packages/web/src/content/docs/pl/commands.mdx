...
Utwórz `.loongcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `loongcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji loongcode:
...
- Globalnie: `~/.config/loongcode/commands/`
- Na projekt: `.loongcode/commands/`
...
loongcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
