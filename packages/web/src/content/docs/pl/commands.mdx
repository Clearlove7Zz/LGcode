...
Utwórz `.lgcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `lgcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji lgcode:
...
- Globalnie: `~/.config/lgcode/commands/`
- Na projekt: `.lgcode/commands/`
...
lgcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
