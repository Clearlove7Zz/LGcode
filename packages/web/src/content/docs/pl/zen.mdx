---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez LGcode.
---
...
LGcode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół LGcode.

Zen działa jak każdy inny dostawca w LGcode. Logujesz się do LGcode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z LGcode.
:::
...
LGcode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

LGcode Zen działa jak każdy inny dostawca w LGcode.

1. Logujesz się do **<a href={console}>LGcode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz LGcode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji LGcode używa formatu
`lgcode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`lgcode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w LGcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w LGcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w LGcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w LGcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w LGcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w LGcode także dowolnego innego dostawcy.
