---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Loongcode.
---
...
Loongcode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Loongcode.

Zen działa jak każdy inny dostawca w Loongcode. Logujesz się do Loongcode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Loongcode.
:::
...
Loongcode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Loongcode Zen działa jak każdy inny dostawca w Loongcode.

1. Logujesz się do **<a href={console}>Loongcode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Loongcode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Loongcode używa formatu
`loongcode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`loongcode/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w Loongcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Loongcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Loongcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Loongcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Loongcode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy Loongcode Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Loongcode także dowolnego innego dostawcy.
