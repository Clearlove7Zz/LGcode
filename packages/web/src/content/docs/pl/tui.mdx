---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala lgcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

lgcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie lgcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI lgcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do lgcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij lgcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `lgcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo LGcode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `lgcode.default`.
