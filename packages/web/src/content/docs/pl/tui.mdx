---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala loongcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

loongcode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie loongcode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI loongcode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do loongcode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij loongcode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `loongcode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Loongcode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `loongcode.default`.
