...
Identyfikator modelu jest taki sam, jak w konfiguracji LGcode w `provider/model-id`. Na przykład, [LGcode Zen](/docs/zen), użyj `opencode/gpt-5.1-codex` dla GPT 5.1 Codex.
