...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
Oto [przykładowa rozmowa](https://modelhub.lgdg.cc/s/4XP1fce5) z opencode.
