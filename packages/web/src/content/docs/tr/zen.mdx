---
title: Zen
description: loongcode tarafından sağlanan seçilmiş modeller listesi.
---
...
Loongcode Zen, Loongcode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Loongcode'daki diğer sağlayıcılar gibi çalışır. Loongcode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Loongcode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Loongcode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Loongcode Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Loongcode Zen, Loongcode'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Loongcode Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Loongcode Zen'i seçin ve API anahtarınızı yapıştırın.
...
Loongcode yapılandırmanızdaki [model id](/docs/config/#models) `loongcode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `loongcode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Loongcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Loongcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Loongcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Loongcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Loongcode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Loongcode Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Loongcode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
