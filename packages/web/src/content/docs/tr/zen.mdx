---
title: Zen
description: lgcode tarafından sağlanan seçilmiş modeller listesi.
---
...
LGcode Zen, LGcode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, LGcode'daki diğer sağlayıcılar gibi çalışır. LGcode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve LGcode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
LGcode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
LGcode Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

LGcode Zen, LGcode'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>LGcode Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, LGcode Zen'i seçin ve API anahtarınızı yapıştırın.
...
LGcode yapılandırmanızdaki [model id](/docs/config/#models) `lgcode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `lgcode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için LGcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için LGcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için LGcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için LGcode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için LGcode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
LGcode Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca LGcode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
