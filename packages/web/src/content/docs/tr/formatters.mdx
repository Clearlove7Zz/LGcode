...
description: loongcode dile özgü biçimlendiriciler kullanır.
---

loongcode, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

loongcode, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, loongcode bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

loongcode bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri loongcode yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
