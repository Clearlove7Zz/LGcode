---
title: Paylasim
description: loongcode konusmalarini genel baglantilarla paylasin.
---

loongcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda loongcode:
...
loongcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak loongcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `loongcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda loongcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
