---
title: Özel Araçlar
description: LLM'un loongcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. loongcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.loongcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/loongcode/tools/` içine yerleştirerek.
