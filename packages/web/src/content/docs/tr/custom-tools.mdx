---
title: Özel Araçlar
description: LLM'un lgcode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. lgcode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.lgcode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/lgcode/tools/` içine yerleştirerek.
