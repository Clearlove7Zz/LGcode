...
- **macOS/Linux**: `~/.config/opencode/lgcode.jsonc` (or `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (older installs): `~/.local/share/opencode/lgcode.jsonc`
- **Windows**: Press `WIN+R` and paste `%USERPROFILE%\.config\opencode\lgcode.jsonc`
