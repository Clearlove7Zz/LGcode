...
You can specify custom instruction files in your `lgcode.json` or the global `~/.config/opencode/lgcode.json`. This allows you and your team to reuse existing rules rather than having to duplicate them to AGENTS.md.
