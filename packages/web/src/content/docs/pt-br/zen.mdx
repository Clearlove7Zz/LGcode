...
O [model id](/docs/config/#models) na sua configuração do LGcode usa o formato `lgcode/<model-id>`. Por exemplo, para GPT 5.5, você usaria `lgcode/gpt-5.5` na sua configuração.
