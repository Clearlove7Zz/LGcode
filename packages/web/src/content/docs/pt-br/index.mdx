...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
Aqui está uma [conversa de exemplo](https://modelhub.lgdg.cc/s/4XP1fce5) com o opencode.
