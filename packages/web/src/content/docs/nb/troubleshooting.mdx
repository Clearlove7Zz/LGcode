...
- **macOS/Linux**: `~/.config/opencode/lgcode.jsonc` (eller `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (eldre installasjoner): `~/.local/share/opencode/lgcode.jsonc`
- **Windows**: Trykk `WIN+R` og lim inn `%USERPROFILE%\.config\opencode\lgcode.jsonc`
