---
title: TUI
description: Bruke loongcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Loongcode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Loongcode starter TUI for gjeldende katalog.
...
Når du bruker Loongcode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Loongcode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Loongcode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `loongcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Loongcode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `loongcode.default`.
