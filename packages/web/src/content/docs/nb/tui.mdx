---
title: TUI
description: Bruke lgcode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LGcode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre LGcode starter TUI for gjeldende katalog.
...
Når du bruker LGcode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til LGcode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt LGcode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `lgcode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge LGcode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `lgcode.default`.
