...
Agentferdigheter lar LGcode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går lgcode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
lgcode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `lgcode.json`:
