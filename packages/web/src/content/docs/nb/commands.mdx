...
Opprett `.loongcode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Loongcode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Loongcode [config](/docs/config):
...
- Per prosjekt: `.loongcode/commands/`
...
Loongcode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
