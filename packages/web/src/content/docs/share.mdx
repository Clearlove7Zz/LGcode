---
title: Share
description: Share your LGcode conversations.
---

LGcode's share feature allows you to create public links to your LGcode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, LGcode:
...
LGcode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, LGcode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `lgcode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using lgcode in your organization.
