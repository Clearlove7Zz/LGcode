...
สร้าง `.loongcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Loongcode:
...
- ระดับผู้ใช้ (Global): `~/.config/loongcode/commands/`
- ระดับโปรเจ็กต์: `.loongcode/commands/`
...
Loongcode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
