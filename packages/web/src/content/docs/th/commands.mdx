...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ LGcode:
...
- ระดับผู้ใช้ (Global): `~/.config/lgcode/commands/`
- ระดับโปรเจ็กต์: `.lgcode/commands/`
...
LGcode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
