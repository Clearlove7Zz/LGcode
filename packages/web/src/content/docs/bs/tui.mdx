---
title: TUI
description: Korištenje korisničkog interfejsa Loongcode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Loongcode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Loongcode pokreće TUI za trenutni direktorij.
...
Kada koristite Loongcode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Loongcode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Loongcode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `loongcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Loongcode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `loongcode.default`.
