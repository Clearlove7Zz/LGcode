---
title: TUI
description: Korištenje korisničkog interfejsa LGcode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LGcode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje LGcode pokreće TUI za trenutni direktorij.
...
Kada koristite LGcode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u LGcode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz LGcode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `lgcode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo LGcode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `lgcode.default`.
