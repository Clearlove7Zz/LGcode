...
Mozete navesti prilagodene datoteke uputstava u `lgcode.json` ili globalnom `~/.config/opencode/lgcode.json`. Tako vi i tim ponovo koristite postojeca pravila bez dupliranja u AGENTS.md.
