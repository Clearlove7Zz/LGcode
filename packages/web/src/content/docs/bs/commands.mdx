...
Kreiraj `.lgcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz LGcode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom LGcode [config](/docs/config):
...
- Globalno: `~/.config/lgcode/commands/`
- Po projektu: `.lgcode/commands/`
...
LGcode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
