...
Kreiraj `.loongcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Loongcode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Loongcode [config](/docs/config):
...
- Globalno: `~/.config/loongcode/commands/`
- Po projektu: `.loongcode/commands/`
...
Loongcode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
