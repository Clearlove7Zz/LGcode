...
- **macOS/Linux**: `~/.config/opencode/lgcode.jsonc` (ili `~/.config/opencode/lgcode.json`)
- **macOS/Linux** (starije instalacije): `~/.local/share/opencode/lgcode.jsonc`
- **Windows**: Pritisnite `WIN+R` i zalijepite `%USERPROFILE%\.config\opencode\lgcode.jsonc`
