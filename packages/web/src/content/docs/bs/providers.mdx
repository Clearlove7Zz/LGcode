...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite opencode i idite na [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
:::tip
Ollama se može automatski konfigurirati za LGcode. Pogledajte [Ollama integracijske dokumente](https://docs.ollama.com/integrations/opencode) za detalje.
:::
