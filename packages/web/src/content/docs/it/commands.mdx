...
Puoi aggiungere comandi personalizzati tramite la config di LGcode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di LGcode:
...
- Globale: `~/.config/lgcode/commands/`
- Per progetto: `.lgcode/commands/`
...
lgcode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
