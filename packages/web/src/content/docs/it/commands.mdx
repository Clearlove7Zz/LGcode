...
Crea `.loongcode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Loongcode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Loongcode:
...
- Globale: `~/.config/loongcode/commands/`
- Per progetto: `.loongcode/commands/`
...
loongcode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
