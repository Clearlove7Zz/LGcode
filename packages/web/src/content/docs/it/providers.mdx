...
1. Esegui `/connect` nella TUI, seleziona opencode e vai su [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
:::tip
Ollama può auto-configurarsi per LGcode. Vedi la [documentazione di integrazione Ollama](https://docs.ollama.com/integrations/opencode) per dettagli.
:::
