---
title: TUI
description: Brug af Loongcode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Loongcode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Loongcode starter TUI for den nuværende mappe.
...
Når du bruger Loongcode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Loongcode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Loongcode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `loongcode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Loongcode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `loongcode.default`.
