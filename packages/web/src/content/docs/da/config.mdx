...
Placer din globale OpenCode-konfiguration i `~/.config/opencode/lgcode.json`. Brug global konfiguration til brugerdækkende præferencer som temaer, udbydere eller nøglebindinger.
