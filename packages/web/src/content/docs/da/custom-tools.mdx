...
description: Opret værktøjer, som LLM kan kalde loongcode ind.
---
...
- Lokalt ved at placere dem i biblioteket `.loongcode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/loongcode/tools/`.
