...
description: Opret værktøjer, som LLM kan kalde lgcode ind.
---
...
- Lokalt ved at placere dem i biblioteket `.lgcode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/lgcode/tools/`.
