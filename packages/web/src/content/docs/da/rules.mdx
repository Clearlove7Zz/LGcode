...
Du kan også ha globale regler i en `~/.config/opencode/AGENTS.md`-fil. Dette blir brugt på alle lgcode-sessioner.
...
Du kan spesifisere egendefinerte instruksjonsfiler i din `lgcode.json` eller den globale `~/.config/opencode/lgcode.json`. Dette lar deg og teamet ditt gjenbruge eksisterende regler i stedet for at måtte duplisere dem til AGENTS.md.
