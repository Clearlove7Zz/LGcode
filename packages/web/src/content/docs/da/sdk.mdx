...
Brug den til at bygge integrasjoner og kontrollere loongcode programmatisk.
...
Opret en forekomst av loongcode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `loongcode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av loongcode, kan du oprete en klientforekomst for at koble til den:
