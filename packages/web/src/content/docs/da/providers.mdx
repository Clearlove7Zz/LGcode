...
1. Kør kommandoen `/connect` i TUI, vælg opencode og gå til [modelhub.lgdg.cc/auth](https://modelhub.lgdg.cc/auth).
...
:::tip
Ollama kan automatisk konfigurere sig selv for LGcode. Se [Ollama-integrationsdokumenterne](https://docs.ollama.com/integrations/opencode) for detaljer.
:::
