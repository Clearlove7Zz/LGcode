...
Agentferdigheter lar Loongcode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Loongcode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Loongcode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `loongcode.json`:
