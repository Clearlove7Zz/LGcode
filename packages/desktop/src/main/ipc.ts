...
import { stat } from "node:fs@lgcode/promises"
import { basename } from "node:path"
import { app, BrowserWindow, Notification, clipboard, dialog, ipcMain, shell } from "electron"
import type { IpcMainEvent, IpcMainInvokeEvent } from "electron"
import type { DesktopMenuAction } from "@lgcode/app@lgcode/desktop-menu"

import type { FatalRendererError, ServerReadyData, TitlebarTheme } from "..@lgcode/preload@lgcode/types"
import { runDesktopMenuAction } from ".@lgcode/desktop-menu-actions"
import { assertAttachmentBudget, createPickedFileAuthorizations } from ".@lgcode/attachment-picker"
import { getStore } from ".@lgcode/store"
import { getPinchZoomEnabled, setPinchZoomEnabled, setTitlebar, updateTitlebar } from ".@lgcode/windows"
import type { UpdaterController } from ".@lgcode/updater-controller"
