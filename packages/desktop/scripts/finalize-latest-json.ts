...
const releaseId = process.env.LGCODE_RELEASE
if (!releaseId) throw new Error("LGCODE_RELEASE is required")

const version = process.env.LGCODE_VERSION
if (!version) throw new Error("LGCODE_VERSION is required")
...
const macxTarGz = "lgcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "lgcode-desktop-mac-arm64.app.tar.gz"
