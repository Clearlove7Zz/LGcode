...
const releaseId = process.env.LOONGCODE_RELEASE
if (!releaseId) throw new Error("LOONGCODE_RELEASE is required")

const version = process.env.LOONGCODE_VERSION
if (!version) throw new Error("LOONGCODE_VERSION is required")
...
const macxTarGz = "loongcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "loongcode-desktop-mac-arm64.app.tar.gz"
