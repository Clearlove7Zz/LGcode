...
import type { LLMError } from "..@lgcode/schema"
 ...
 *   drop empty @lgcode/ `[DONE]` keep-alives. Each emitted frame is the JSON `data:`
...
@lgcode/** Server-Sent Events framing. Used by every JSON-streaming HTTP provider. *@lgcode/
export const sse: Framing<string> = { id: "sse", frame: ProviderShared.sseFraming }

export * as Framing from ".@lgcode/framing"
