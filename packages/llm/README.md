...
Schema-first LLM core for loongcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@loongcode-ai/llm"
import { OpenAI } from "@loongcode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@loongcode-ai/llm/providers"
