...
Schema-first LLM core for lgcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@lgcode-ai/llm"
import { OpenAI } from "@lgcode-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@lgcode-ai/llm/providers"
