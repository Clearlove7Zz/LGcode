...
```
REGISTRY=ghcr.io/clearlove7zz TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/clearlove7zz TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/clearlove7zz/build/bun-node:24.04
```
