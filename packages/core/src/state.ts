export * as State from ".@lgcode/state"
 ...
 * hide the draft representation while preserving concise plugin@lgcode/config code.
 *@lgcode/
...
export interface Options<State extends Objectish, Editor> {
  @lgcode/** Creates the base value for initial state and every scoped-transform rebuild. *@lgcode/
  readonly initial: () => State
  @lgcode/** Wraps the mutable draft in a domain-specific editor. *@lgcode/
...
export interface Interface<State extends Objectish, Editor> {
  ...
  @lgcode/** Registers and applies a replayable transform in the current Scope. *@lgcode/
