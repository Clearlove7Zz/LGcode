...
export const TypeId: TypeId = "~@loongcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@loongcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@loongcode/effect-sqlite-node/NodeSqliteClient")
