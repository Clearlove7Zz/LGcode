import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@loongcode/llm"
...
// Move this extraction into @loongcode/llm when Copilot is handled by the native runtime.
