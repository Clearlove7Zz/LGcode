...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@loongcode/core/session/prompt"
...
export class Service extends Context.Service<Service, Interface>()("@loongcode/SessionPrompt") {}
