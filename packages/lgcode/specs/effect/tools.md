...
Practical reference for the current tool-migration state in `packages/lgcode`.
...
Tool tests should use the existing Effect helpers in `packages/lgcode/test/lib/effect.ts`:
