...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "url='https://github.com/Clearlove7Zz/LoongCode'",
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('loongcode')",
    "conflicts=('loongcode')",
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/Clearlove7Zz/LoongCode/releases/download/v\${pkgver}\${_subver}/loongcode-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/Clearlove7Zz/LoongCode/releases/download/v\${pkgver}\${_subver}/loongcode-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    `  homepage "https://github.com/Clearlove7Zz/LoongCode.git"`,
    ...
    `      url "https://github.com/Clearlove7Zz/LoongCode/releases/download/v${Script.version}/loongcode-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/Clearlove7Zz/LoongCode/releases/download/v${Script.version}/loongcode-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "loongcode"',
    ...
    `      url "https://github.com/Clearlove7Zz/LoongCode/releases/download/v${Script.version}/loongcode-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "loongcode"',
    "      end",
    ...
    `      url "https://github.com/Clearlove7Zz/LoongCode/releases/download/v${Script.version}/loongcode-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "loongcode"',
    "      end",
