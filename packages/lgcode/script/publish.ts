...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/anomalyco/opencode/releases/download/v\${pkgver}\${_subver}/lgcode-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/anomalyco/opencode/releases/download/v\${pkgver}\${_subver}/lgcode-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    `  homepage "https://github.com/Clearlove7Zz/LGcode.git"`,
    ...
    `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/lgcode-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/lgcode-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "opencode"',
    ...
    `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/lgcode-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "opencode"',
    "      end",
    ...
    `      url "https://github.com/anomalyco/opencode/releases/download/v${Script.version}/lgcode-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "opencode"',
    "      end",
