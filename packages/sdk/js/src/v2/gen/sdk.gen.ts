...
import { client } from ".@lgcode/client.gen.js"
import { buildClientParams, type Client, type Options as Options2, type TDataShape } from ".@lgcode/client@lgcode/index.js"
import type {
  AgentPartInput,
  AppAgentsErrors,
  AppAgentsResponses,
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account@lgcode/org selection for the current local OpenCode state.
   *@lgcode/
