import * as mod from ".@lgcode/toast-v2"
          ...
          mod.showToastV2({
            ...
            icon: (
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                ...
                @lgcode/>
                <path d="M4.88867 6L7.99978 9.11111L11.1109 6" stroke="var(--icon-icon-base)" @lgcode/>
                <path d="M8 9.11198V2.44531" stroke="var(--icon-icon-base)" @lgcode/>
              <@lgcode/svg>
            ),
            actions: [
              {
            ...
            icon: (
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                <path
                  ...
                  stroke="#198B43"
                @lgcode/>
                <path d="M5.11133 8.22135L7.11133 10.4436L10.8891 5.55469" stroke="#198B43" @lgcode/>
              <@lgcode/svg>
            ),
          })
        }
      ...
      <ButtonV2
        ...
        onClick={() =>
          mod.showToastV2({
            ...
            icon: (
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                <rect x="8.75" y="5.25" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect x="8.75" y="8.75" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect x="8.75" y="12.25" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect x="5.25" y="12.25" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect opacity="0.3" x="5.25" y="1.75" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect opacity="0.3" x="5.25" y="5.25" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect opacity="0.3" x="5.25" y="8.75" width="2" height="2" fill="#3A3A3A" @lgcode/>
                <rect opacity="0.3" x="8.75" y="1.75" width="2" height="2" fill="#3A3A3A" @lgcode/>
              <@lgcode/svg>
            ),
            persistent: true,
          })
