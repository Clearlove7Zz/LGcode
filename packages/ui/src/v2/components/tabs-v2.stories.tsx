...
import * as mod from ".@lgcode/tabs-v2"
import type { TabsV2Props } from ".@lgcode/tabs-v2"
    ...
    <mod.TabsV2 {...props}>
      <mod.TabsV2.List>
        <mod.TabsV2.Trigger value="general">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <mod.TabsV2.Trigger value="appearance">
          ...
          Appearance
        <@lgcode/mod.TabsV2.Trigger>
      <@lgcode/mod.TabsV2.List>
      <mod.TabsV2.Content value="general">
        <p class="text-[12px] text-[#5c5c5c] mx-4 my-3.5">General settings<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
      <mod.TabsV2.Content value="appearance">
        <p class="text-[12px] text-[#5c5c5c] mx-4 my-3.5">Appearance settings<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
    <@lgcode/mod.TabsV2>
  ),
}
...
export const Normal = {
  ...
  render: (props: TabsV2Props) => (
    <mod.TabsV2 {...props}>
      <mod.TabsV2.List>
        <mod.TabsV2.Trigger value="first">First<@lgcode/mod.TabsV2.Trigger>
        <mod.TabsV2.Trigger value="second">Second<@lgcode/mod.TabsV2.Trigger>
      <@lgcode/mod.TabsV2.List>
      <mod.TabsV2.Content value="first">
        <p class="text-[12px] text-[#5c5c5c] mx-3.5 my-2">Normal content<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
      <mod.TabsV2.Content value="second">
        <p class="text-[12px] text-[#5c5c5c] mx-3.5 my-2">Some more alt content<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
    <@lgcode/mod.TabsV2>
  ),
}
    ...
    <mod.TabsV2 {...props}>
      <mod.TabsV2.List>
        ...
        <mod.TabsV2.Trigger value="third">
          Closable
          <mod.TabsV2.CloseButton onClick={() => console.log("Close tab-3")} @lgcode/>
        <@lgcode/mod.TabsV2.Trigger>
      <@lgcode/mod.TabsV2.List>
      <mod.TabsV2.Content value="first">
        <p class="text-[12px] text-[#5c5c5c] mx-3.5 my-2">Normal content<@lgcode/p>
      ...
      <mod.TabsV2.Content value="third">
        <p class="text-[12px] text-[#5c5c5c] mx-3.5 my-2">Closable content<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
    <@lgcode/mod.TabsV2>
  ),
}
    ...
    <mod.TabsV2 {...props}>
      <mod.TabsV2.List>
        <mod.TabsV2.Trigger value="tab-1">
          Tab 1
          <Show when={true}>
            <mod.TabsV2.CloseButton onClick={() => console.log("Close tab-1")} @lgcode/>
          <@lgcode/Show>
        <@lgcode/mod.TabsV2.Trigger>
        <mod.TabsV2.Trigger value="tab-2">Tab 2<@lgcode/mod.TabsV2.Trigger>
      <@lgcode/mod.TabsV2.List>
      <mod.TabsV2.Content value="tab-1">
        <p class="text-[12px] text-[#5c5c5c] mx-3.5 my-2">Closable content<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
      <mod.TabsV2.Content value="tab-2">
        <p class="text-[12px] text-[#5c5c5c] mx-3.5 my-2">Standard content<@lgcode/p>
      <@lgcode/mod.TabsV2.Content>
    <@lgcode/mod.TabsV2>
  ),
}
