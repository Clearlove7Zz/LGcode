...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/loongcode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy loongcode service removed
