...
Practical reference for the current tool-migration state in `packages/loongcode`.
...
Tool tests should use the existing Effect helpers in `packages/loongcode/test/lib/effect.ts`:
