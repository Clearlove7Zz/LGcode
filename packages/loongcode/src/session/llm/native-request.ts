import type { JsonSchema, LLMRequest, ProviderMetadata } from "@loongcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@loongcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @loongcode/llm request objects from loongcode's session/AI SDK-shaped data.
  return LLM.request({
