...
import type { Event, GlobalEvent, OpencodeClient } from "@loongcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@loongcode/RunStreamTransport") {}
