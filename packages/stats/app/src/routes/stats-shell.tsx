import opencodeWordmarkDark from "../asset/logo-ornate-dark.png"
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://modelhub.lgdg.cc/legal/terms-of-service", label: "Terms of service" },
    { href: "https://modelhub.lgdg.cc/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
