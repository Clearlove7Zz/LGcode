...
class Database extends Context.Service<Database, DatabaseShape>()("@loongcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@loongcode/example/UserStore") {
