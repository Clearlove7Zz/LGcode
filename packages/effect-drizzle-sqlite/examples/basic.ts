...
class Database extends Context.Service<Database, DatabaseShape>()("@lgcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@lgcode/example/UserStore") {
