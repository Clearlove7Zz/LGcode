...
import { ResizeHandle } from "@loongcode/ui/resize-handle"
...
import { Session, type Message } from "@loongcode/sdk/v2/client"
...
import { toaster } from "@loongcode/ui/toast"
...
import { useTheme, type ColorScheme } from "@loongcode/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://modelhub.lgdg.cc/desktop-feedback")}
      renderPanel={() =>
