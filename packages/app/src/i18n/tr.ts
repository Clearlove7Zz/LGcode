...
export const dict = {
  ...
  "dialog.provider.loongcode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.loongcode.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.loongcodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Loongcode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Loongcode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.loongcodeZen.line1":
    "Loongcode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.loongcodeZen.visit.prefix": "",
  "provider.connect.loongcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.loongcodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Loongcode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Loongcode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler loongcode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Loongcode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Loongcode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Loongcode ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (loongcode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Loongcode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Loongcode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Loongcode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Loongcode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Loongcode'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Loongcode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Loongcode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Loongcode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Loongcode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Loongcode'un en son sürümünü kullanıyorsunuz.",
