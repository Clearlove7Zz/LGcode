export const dict = {
  ...
  "provider.connect.title.anthropicProMax": "Iniciar sesión con Claude Pro@lgcode/Max",
  ...
  "provider.custom.field.baseURL.placeholder": "https:@lgcode/@lgcode/api.miproveedor.com@lgcode/v1",
  ...
  "provider.custom.error.baseURL.format": "Debe comenzar con http:@lgcode/@lgcode/ o https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "Tokens de Caché (lectura@lgcode/escritura)",
  ...
  "error.chain.modelNotFound": "Modelo no encontrado: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "Comprueba los nombres de proveedor@lgcode/modelo en tu configuración (opencode.json)",
