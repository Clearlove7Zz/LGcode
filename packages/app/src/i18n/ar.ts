export const dict = {
  ...
  "dialog.provider.anthropic.note": "اتصل باستخدام Claude Pro@lgcode/Max أو مفتاح API",
  "dialog.provider.copilot.note": "اتصل باستخدام Copilot أو مفتاح API",
  "dialog.provider.openai.note": "اتصل باستخدام ChatGPT Pro@lgcode/Plus أو مفتاح API",
  ...
  "provider.connect.title.anthropicProMax": "تسجيل الدخول باستخدام Claude Pro@lgcode/Max",
  ...
  "provider.custom.error.baseURL.format": "يجب أن يبدأ بـ http:@lgcode/@lgcode/ أو https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "رموز التخزين المؤقت (قراءة@lgcode/كتابة)",
  ...
  "error.chain.modelNotFound": "النموذج غير موجود: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "تحقق من أسماء الموفر@lgcode/النموذج في التكوين (opencode.json)",
