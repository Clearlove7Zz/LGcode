export const dict = {
  ...
  "dialog.provider.loongcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.loongcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.loongcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Loongcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Loongcode-u.",
  ...
  "provider.connect.loongcodeZen.line1":
    "Loongcode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.loongcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.loongcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.loongcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Loongcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Loongcode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u loongcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se Loongcode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Loongcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Loongcode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (loongcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Loongcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Loongcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Loongcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Loongcode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Loongcode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Loongcode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Loongcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Loongcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Loongcode-a.",
