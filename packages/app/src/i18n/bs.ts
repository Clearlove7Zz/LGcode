export const dict = {
  ...
  "command.sidebar.toggle": "Prikaži@lgcode/sakrij bočnu traku",
  ...
  "command.terminal.toggle": "Prikaži@lgcode/sakrij terminal",
  "command.fileTree.toggle": "Prikaži@lgcode/sakrij stablo datoteka",
  "command.review.toggle": "Prikaži@lgcode/sakrij pregled",
  "command.terminal.new": "Novi terminal",
  "command.terminal.new.description": "Kreiraj novu karticu terminala",
  "command.steps.toggle": "Prikaži@lgcode/sakrij korake",
  ...
  "command.mcp.toggle": "Prikaži@lgcode/sakrij MCP-ove",
  "command.mcp.toggle.description": "Prikaži@lgcode/sakrij MCP-ove",
  ...
  "command.workspace.toggle": "Prikaži@lgcode/sakrij radne prostore",
  ...
  "dialog.model.manage.provider.toggle": "Uključi@lgcode/isključi sve {{provider}} modele",
  ...
  "provider.connect.title.anthropicProMax": "Prijavi se putem Claude Pro@lgcode/Max",
  ...
  "provider.custom.field.baseURL.placeholder": "https:@lgcode/@lgcode/api.mojprovajder.com@lgcode/v1",
  ...
  "provider.custom.error.baseURL.format": "Mora početi sa http:@lgcode/@lgcode/ ili https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "Cache tokeni (čitanje@lgcode/pisanje)",
  ...
  "error.chain.modelNotFound": "Model nije pronađen: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "Provjeri konfiguraciju (opencode.json) provider@lgcode/model names",
  ...
  "sidebar.menu.toggle": "Prikaži@lgcode/sakrij meni",
