export const dict = {
  ...
  "dialog.provider.loongcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.loongcode.tagline": "Reliable optimized models",
  "dialog.provider.loongcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Loongcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Loongcode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.loongcodeZen.line1":
    "Loongcode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.loongcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.loongcodeZen.visit.prefix": "Visit ",
  "provider.connect.loongcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.loongcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Loongcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Loongcode.",
  ...
  "dialog.plugins.empty": "Plugins configured in loongcode.json",
  ...
  "dialog.server.description": "Switch which Loongcode server this app connects to.",
  ...
  "wsl.onboarding.step.loongcode": "Loongcode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Loongcode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Loongcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Loongcode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Loongcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Loongcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Loongcode",
  "wsl.onboarding.loongcodeReadyIn": "Loongcode is ready in {{distro}}.",
  "wsl.onboarding.loongcodeReady": "Loongcode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Loongcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Loongcode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Loongcode.",
  ...
  "toast.update.description": "A new version of Loongcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Loongcode team",
  ...
  "error.chain.checkConfig": "Check your config (loongcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Loongcode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Loongcode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Loongcode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Loongcode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Loongcode",
  ...
  "settings.general.row.colorScheme.description": "Choose whether Loongcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Loongcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Loongcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Loongcode.",
