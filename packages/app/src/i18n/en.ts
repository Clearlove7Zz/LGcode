export const dict = {
  ...
  "dialog.provider.lgcode.tagline": "Reliable optimized models",
  "dialog.provider.lgcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by LGcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in LGcode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.lgcodeZen.line1":
    "LGcode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.lgcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.lgcodeZen.visit.prefix": "Visit ",
  "provider.connect.lgcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.lgcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in LGcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in LGcode.",
  ...
  "dialog.plugins.empty": "Plugins configured in lgcode.json",
  ...
  "dialog.server.description": "Switch which LGcode server this app connects to.",
  ...
  "wsl.onboarding.step.lgcode": "LGcode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking LGcode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking LGcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating LGcode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating LGcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update LGcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update LGcode",
  "wsl.onboarding.lgcodeReadyIn": "LGcode is ready in {{distro}}.",
  "wsl.onboarding.lgcodeReady": "LGcode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install LGcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install LGcode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen LGcode.",
  ...
  "toast.update.description": "A new version of LGcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the LGcode team",
  ...
  "error.chain.checkConfig": "Check your config (lgcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, LGcode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "LGcode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "LGcode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the LGcode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for LGcode",
  ...
  "settings.general.row.appearance.description": "Customise how LGcode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether LGcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how LGcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when LGcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of LGcode.",
