export const dict = {
  ...
  "command.steps.toggle.description": "현재 메시지의 단계 표시@lgcode/숨기기",
  ...
  "dialog.provider.anthropic.note": "Claude Pro@lgcode/Max 또는 API 키로 연결",
  "dialog.provider.copilot.note": "Copilot 또는 API 키로 연결",
  "dialog.provider.openai.note": "ChatGPT Pro@lgcode/Plus 또는 API 키로 연결",
  ...
  "provider.connect.title.anthropicProMax": "Claude Pro@lgcode/Max로 로그인",
  ...
  "provider.custom.error.baseURL.format": "http:@lgcode/@lgcode/ 또는 https:@lgcode/@lgcode/로 시작해야 합니다",
  ...
  "context.stats.cacheTokens": "캐시 토큰 (읽기@lgcode/쓰기)",
  ...
  "error.chain.modelNotFound": "모델을 찾을 수 없음: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "구성(opencode.json)의 공급자@lgcode/모델 이름을 확인하세요",
