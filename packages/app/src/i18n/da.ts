export const dict = {
  ...
  "provider.connect.title.anthropicProMax": "Log ind med Claude Pro@lgcode/Max",
  ...
  "provider.custom.field.baseURL.placeholder": "https:@lgcode/@lgcode/api.minudbyder.dk@lgcode/v1",
  ...
  "provider.custom.error.baseURL.format": "Skal starte med http:@lgcode/@lgcode/ eller https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "Cache Tokens (læs@lgcode/skriv)",
  ...
  "error.chain.modelNotFound": "Model ikke fundet: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "Tjek dine konfigurations (opencode.json) udbyder@lgcode/modelnavne",
