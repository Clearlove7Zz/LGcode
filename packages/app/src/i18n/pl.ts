export const dict = {
  ...
  "dialog.provider.lgcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.lgcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.lgcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez LGcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w LGcode.",
  ...
  "provider.connect.lgcodeZen.line1":
    "LGcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.lgcodeZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.lgcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.lgcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.lgcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w LGcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w LGcode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w lgcode.json",
  ...
  "dialog.server.description": "Przełącz serwer LGcode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja LGcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu LGcode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (lgcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "LGcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla LGcode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd LGcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy LGcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw LGcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania LGcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji LGcode.",
