export const dict = {
  ...
  "dialog.provider.loongcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.loongcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.loongcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Loongcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Loongcode.",
  ...
  "provider.connect.loongcodeZen.line1":
    "Loongcode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.loongcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.loongcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.loongcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Loongcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Loongcode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w loongcode.json",
  ...
  "dialog.server.description": "Przełącz serwer Loongcode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Loongcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Loongcode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (loongcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Loongcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Loongcode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Loongcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Loongcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Loongcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Loongcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Loongcode.",
