export const dict = {
  ...
  "provider.connect.title.anthropicProMax": "Zaloguj się z Claude Pro@lgcode/Max",
  ...
  "provider.custom.field.baseURL.placeholder": "https:@lgcode/@lgcode/api.mojdostawca.com@lgcode/v1",
  ...
  "provider.custom.error.baseURL.format": "Musi zaczynać się od http:@lgcode/@lgcode/ lub https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "Tokeny pamięci podręcznej (odczyt@lgcode/zapis)",
  ...
  "error.chain.modelNotFound": "Model nie znaleziony: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (opencode.json) nazwy dostawców@lgcode/modeli",
