export const dict = {
  ...
  "provider.connect.title.anthropicProMax": "เข้าสู่ระบบด้วย Claude Pro@lgcode/Max",
  ...
  "provider.custom.error.baseURL.format": "ต้องขึ้นต้นด้วย http:@lgcode/@lgcode/ หรือ https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "โทเค็นแคช (อ่าน@lgcode/เขียน)",
  ...
  "error.chain.modelNotFound": "ไม่พบโมเดล: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (opencode.json) ชื่อผู้ให้บริการ@lgcode/โมเดล",
