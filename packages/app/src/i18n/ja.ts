export const dict = {
  ...
  "dialog.provider.anthropic.note": "Claude Pro@lgcode/MaxまたはAPIキーで接続",
  "dialog.provider.copilot.note": "CopilotまたはAPIキーで接続",
  "dialog.provider.openai.note": "ChatGPT Pro@lgcode/PlusまたはAPIキーで接続",
  ...
  "provider.connect.title.anthropicProMax": "Claude Pro@lgcode/Maxでログイン",
  ...
  "provider.custom.error.baseURL.format": "http:@lgcode/@lgcode/ または https:@lgcode/@lgcode/ で始まる必要があります",
  ...
  "context.stats.cacheTokens": "キャッシュトークン (読込@lgcode/書込)",
  ...
  "error.chain.modelNotFound": "モデルが見つかりません: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "config (opencode.json) のプロバイダー@lgcode/モデル名を確認してください",
  ...
  "debugBar.fps.tip": "過去5秒間のローリングフレーム@lgcode/秒。",
