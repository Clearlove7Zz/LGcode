...
export const dict = {
  ...
  "dialog.provider.loongcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.loongcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.loongcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Loongcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Loongcode.",
  ...
  "provider.connect.loongcodeZen.line1":
    "Loongcode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.loongcodeZen.visit.prefix": "Besøk ",
  "provider.connect.loongcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.loongcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Loongcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Loongcode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i loongcode.json",
  ...
  "dialog.server.description": "Bytt hvilken Loongcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Loongcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Loongcode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (loongcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Loongcode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Loongcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Loongcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Loongcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Loongcode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Loongcode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Loongcode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Loongcode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Loongcode.",
