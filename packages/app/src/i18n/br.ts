export const dict = {
  ...
  "dialog.provider.anthropic.note": "Conectar com Claude Pro@lgcode/Max ou chave de API",
  "dialog.provider.copilot.note": "Conectar com Copilot ou chave de API",
  "dialog.provider.openai.note": "Conectar com ChatGPT Pro@lgcode/Plus ou chave de API",
  ...
  "provider.connect.title.anthropicProMax": "Entrar com Claude Pro@lgcode/Max",
  ...
  "provider.custom.field.baseURL.placeholder": "https:@lgcode/@lgcode/api.meuprovedor.com@lgcode/v1",
  ...
  "provider.custom.error.baseURL.format": "Deve começar com http:@lgcode/@lgcode/ ou https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "Tokens de Cache (leitura@lgcode/escrita)",
  ...
  "error.chain.modelNotFound": "Modelo não encontrado: {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "Verifique os nomes de provedor@lgcode/modelo na sua configuração (opencode.json)",
