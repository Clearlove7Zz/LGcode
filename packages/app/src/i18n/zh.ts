...
export const dict = {
  ...
  "dialog.provider.anthropic.note": "使用 Claude Pro@lgcode/Max 或 API 密钥连接",
  "dialog.provider.copilot.note": "使用 Copilot 或 API 密钥连接",
  "dialog.provider.openai.note": "使用 ChatGPT Pro@lgcode/Plus 或 API 密钥连接",
  ...
  "provider.connect.title.anthropicProMax": "使用 Claude Pro@lgcode/Max 登录",
  ...
  "provider.custom.error.baseURL.format": "必须以 http:@lgcode/@lgcode/ 或 https:@lgcode/@lgcode/ 开头",
  ...
  "dialog.mcp.description": "已启用 {{enabled}} @lgcode/ {{total}}",
  ...
  "context.stats.cacheTokens": "缓存 token（读@lgcode/写）",
  ...
  "error.chain.modelNotFound": "未找到模型：{{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "请检查你的配置 (opencode.json) 中的 provider@lgcode/model 名称",
  ...
  "session.question.progress": "{{current}}@lgcode/{{total}} 个问题",
  ...
  "debugBar.mem.tip": "使用的 JS 堆与堆限制。{{used}} @lgcode/ {{limit}}。",
