...
export const dict = {
  ...
  "dialog.provider.loongcode.note": "使用 Loongcode Zen 或 API 密钥连接",
  "dialog.provider.loongcode.tagline": "可靠的优化模型",
  "dialog.provider.loongcodeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Loongcode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Loongcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.loongcodeZen.line1": "Loongcode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.loongcodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.loongcodeZen.visit.prefix": "访问 ",
  "provider.connect.loongcodeZen.visit.link": "modelhub.lgdg.cc/zen",
  "provider.connect.loongcodeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Loongcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Loongcode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 loongcode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Loongcode 服务器。",
  ...
  "toast.update.description": "Loongcode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Loongcode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (loongcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Loongcode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Loongcode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Loongcode 服务器。",
  ...
  "settings.general.row.language.description": "更改 Loongcode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Loongcode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Loongcode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Loongcode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Loongcode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Loongcode。",
