export const dict = {
  ...
  "dialog.provider.anthropic.note": "Connectez-vous avec Claude Pro@lgcode/Max ou une clé API",
  "dialog.provider.copilot.note": "Connectez-vous avec Copilot ou une clé API",
  "dialog.provider.openai.note": "Connectez-vous avec ChatGPT Pro@lgcode/Plus ou une clé API",
  ...
  "provider.connect.title.anthropicProMax": "Connexion avec Claude Pro@lgcode/Max",
  ...
  "provider.custom.field.baseURL.placeholder": "https:@lgcode/@lgcode/api.monfournisseur.com@lgcode/v1",
  ...
  "provider.custom.error.baseURL.format": "Doit commencer par http:@lgcode/@lgcode/ ou https:@lgcode/@lgcode/",
  ...
  "context.stats.cacheTokens": "Jetons de cache (lecture@lgcode/écriture)",
  ...
  "error.chain.modelNotFound": "Modèle introuvable : {{provider}}@lgcode/{{model}}",
  "error.chain.checkConfig": "Vérifiez votre configuration (opencode.json) pour les noms de fournisseur@lgcode/modèle",
