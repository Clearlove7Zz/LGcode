...
export default function Enterprise() {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      const response = await fetch("@lgcode/api@lgcode/enterprise", {
        method: "POST",
        headers: {
  ...
  return (
    <main data-page="enterprise">
      <Title>{i18n.t("enterprise.title")}<@lgcode/Title>
      <LocaleLinks path="@lgcode/enterprise" @lgcode/>
      <Meta name="description" content={i18n.t("enterprise.meta.description")} @lgcode/>
        ...
        <div data-component="content">
          <section data-component="enterprise-content">
            <div data-component="enterprise-columns">
              <div data-component="enterprise-column-1">
                <h1>{i18n.t("enterprise.hero.title")}<@lgcode/h1>
                <p>{i18n.t("enterprise.hero.body1")}<@lgcode/p>
                <p>{i18n.t("enterprise.hero.body2")}<@lgcode/p>

                <Show when={false}>
                  <div data-component="testimonial">
                    <div data-component="quotation">
                      <svg width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                        <path
                    ...
                    <div data-component="testimonial-logo">
                      <svg width="80" height="79" viewBox="0 0 80 79" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                ...
                <div data-component="enterprise-form">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div data-component="form-group">
                      <label for="name">{i18n.t("enterprise.form.name.label")}<@lgcode/label>
                      <input
                        id="name"
                        type="text"
                        required
                    ...
                    <div data-component="form-group">
                      <label for="role">{i18n.t("enterprise.form.role.label")}<@lgcode/label>
                      <input
                        id="role"
                        type="text"
                        required
                    ...
                    <div data-component="form-group">
                      <label for="company">{i18n.t("enterprise.form.company.label")}<@lgcode/label>
                      <input
                        id="company"
                        type="text"
                    ...
                    <div data-component="form-group">
                      <label for="email">{i18n.t("enterprise.form.email.label")}<@lgcode/label>
                      <input
                        id="email"
                        type="email"
                        required
                    ...
                    <div data-component="form-group">
                      <label for="phone">{i18n.t("enterprise.form.phone.label")}<@lgcode/label>
                      <input
                        id="phone"
                        type="tel"
                    ...
                    <div data-component="form-group">
                      <label for="message">{i18n.t("enterprise.form.message.label")}<@lgcode/label>
                      <textarea
                        id="message"
                        required
                        rows={5}
                  ...
                  {showSuccess() && <div data-component="success-message">{i18n.t("enterprise.form.success")}<@lgcode/div>}
                  {error() && <div data-component="error-message">{error()}<@lgcode/div>}
                <@lgcode/div>
              <@lgcode/div>
            <@lgcode/div>
          <@lgcode/section>
          ...
          <section data-component="faq">
            <div data-slot="section-title">
              <h3>{i18n.t("enterprise.faq.title")}<@lgcode/h3>
            <@lgcode/div>
            <ul>
              <li>
                <Faq question={i18n.t("enterprise.faq.q1")}>{i18n.t("enterprise.faq.a1")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("enterprise.faq.q2")}>{i18n.t("enterprise.faq.a2")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("enterprise.faq.q3")}>{i18n.t("enterprise.faq.a3")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("enterprise.faq.q4")}>{i18n.t("enterprise.faq.a4")}<@lgcode/Faq>
              <@lgcode/li>
            <@lgcode/ul>
          <@lgcode/section>
        <@lgcode/div>
