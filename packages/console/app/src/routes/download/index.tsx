...
import desktopAppIcon from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/opencode-desktop-icon.png"
...
function getDownloadHref(platform: DownloadPlatform, channel: "stable" | "beta" = "stable") {
  return `@lgcode/download@lgcode/${channel}@lgcode/${platform}`
}

function IconDownload(props: JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg" {...props}>
      <path
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>{i18n.t("download.title")}<@lgcode/Title>
      <LocaleLinks path="@lgcode/download" @lgcode/>
      <Meta name="description" content={i18n.t("download.meta.description")} @lgcode/>
      <div data-component="container">
        <Header hideGetStarted @lgcode/>

        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="" @lgcode/>
            <@lgcode/div>
            <div data-component="hero-text">
              <h1>{i18n.t("download.hero.title")}<@lgcode/h1>
              <p>{i18n.t("download.hero.subtitle")}<@lgcode/p>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]<@lgcode/span> {i18n.t("download.section.terminal")}
            <@lgcode/div>
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("curl -fsSL https:@lgcode/@lgcode/opencode.ai@lgcode/install | bash")}
              >
                <code>
                  curl -fsSL https:@lgcode/@lgcode/<strong>opencode.ai@lgcode/install<@lgcode/strong> | bash
                <@lgcode/code>
                <CopyStatus @lgcode/>
              <@lgcode/button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g opencode-ai")}>
                <code>
                  npm i -g <strong>opencode-ai<@lgcode/strong>
                <@lgcode/code>
                <CopyStatus @lgcode/>
              <@lgcode/button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g opencode-ai")}>
                <code>
                  bun add -g <strong>opencode-ai<@lgcode/strong>
                <@lgcode/code>
                <CopyStatus @lgcode/>
              <@lgcode/button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco@lgcode/tap@lgcode/opencode")}>
                <code>
                  brew install <strong>anomalyco@lgcode/tap@lgcode/opencode<@lgcode/strong>
                <@lgcode/code>
                <CopyStatus @lgcode/>
              <@lgcode/button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S opencode")}>
                <code>
                  paru -S <strong>opencode<@lgcode/strong>
                <@lgcode/code>
                <CopyStatus @lgcode/>
              <@lgcode/button>
            <@lgcode/div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]<@lgcode/span> {i18n.t("download.section.desktop")}
            <@lgcode/div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask opencode-desktop")}>
                <code>
                  brew install --cask <strong>opencode-desktop<@lgcode/strong>
                <@lgcode/code>
                <CopyStatus @lgcode/>
              <@lgcode/button>
              <div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>{i18n.t("download.platform.macosAppleSilicon")}<@lgcode/span>
                <@lgcode/div>
              ...
              <div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>{i18n.t("download.platform.macosIntel")}<@lgcode/span>
                <@lgcode/div>
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                      ...
                      <defs>
                        <clipPath id="clip0_2614_159729">
                          <rect width="20" height="20" fill="white" transform="translate(2 2)" @lgcode/>
                        <@lgcode/clipPath>
                      <@lgcode/defs>
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>{i18n.t("download.platform.windowsX64")}<@lgcode/span>
                <@lgcode/div>
              ...
              <div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>{i18n.t("download.platform.linuxDeb")}<@lgcode/span>
                <@lgcode/div>
              ...
              <div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>{i18n.t("download.platform.linuxRpm")}<@lgcode/span>
                <@lgcode/div>
                <a href={language.route(getDownloadHref("linux-x64-rpm"))} data-component="action-button">
                  {i18n.t("download.action.download")}
                <@lgcode/a>
              <@lgcode/div>
              {@lgcode/* Disabled temporarily as it doesn't work *@lgcode/}
              {@lgcode/*<div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                      <path
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>Linux (.AppImage)<@lgcode/span>
                <@lgcode/div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]<@lgcode/span> {i18n.t("download.section.extensions")}
            <@lgcode/div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                      ...
                      <defs>
                        <clipPath id="clip0_2614_159777">
                          <rect width="20" height="20" fill="white" transform="translate(2.5 2)" @lgcode/>
                        <@lgcode/clipPath>
                      <@lgcode/defs>
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>VS Code<@lgcode/span>
                <@lgcode/div>
                <a href={language.route("@lgcode/docs@lgcode/ide@lgcode/")} data-component="action-button">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                      ...
                      <defs>
                        <clipPath id="clip0_2614_159762">
                          <rect width="17" height="20" fill="white" transform="translate(3.5 2)" @lgcode/>
                        <@lgcode/clipPath>
                      <@lgcode/defs>
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>Cursor<@lgcode/span>
                <@lgcode/div>
                <a href={language.route("@lgcode/docs@lgcode/ide@lgcode/")} data-component="action-button">
                  {i18n.t("download.action.install")}
                <@lgcode/a>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]<@lgcode/span> {i18n.t("download.section.integrations")}
            <@lgcode/div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>GitHub<@lgcode/span>
                <@lgcode/div>
                <a href={language.route("@lgcode/docs@lgcode/github@lgcode/")} data-component="action-button">
                  {i18n.t("download.action.install")}
                <@lgcode/a>
              <@lgcode/div>
              ...
              <div data-component="download-row">
                <div data-component="download-info">
                  <span data-slot="icon">
                    ...
                    <@lgcode/svg>
                  <@lgcode/span>
                  <span>GitLab<@lgcode/span>
                <@lgcode/div>
                <a href={language.route("@lgcode/docs@lgcode/gitlab@lgcode/")} data-component="action-button">
                  {i18n.t("download.action.install")}
                <@lgcode/a>
              <@lgcode/div>
            <@lgcode/div>
          ...
          <ul>
            ...
            <li>
              <Faq question={i18n.t("home.faq.q5")}>
                ...
                <a href={language.route("@lgcode/docs@lgcode/cli@lgcode/#web")}>{i18n.t("home.faq.a5.web")}<@lgcode/a>!
              <@lgcode/Faq>
            <@lgcode/li>
            <li>
            ...
            <li>
              <Faq question={i18n.t("home.faq.q7")}>
                ...
                <a href={language.route("@lgcode/docs@lgcode/share@lgcode/#privacy")}>{i18n.t("download.faq.a6.shareLink")}<@lgcode/a>.
              <@lgcode/Faq>
            <@lgcode/li>
            <li>
