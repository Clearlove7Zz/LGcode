          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://modelhub.lgdg.cc/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>modelhub.lgdg.cc/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("brew install Clearlove7Zz/tap/loongcode")}>
                <code>
                  brew install <strong>Clearlove7Zz/tap/loongcode</strong>
                </code>
                <CopyStatus />
              </button>
