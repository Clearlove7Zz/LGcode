...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>OpenCode | Terms of Service<@lgcode/Title>
      <LocaleLinks path="@lgcode/legal@lgcode/terms-of-service" @lgcode/>
      <Meta name="description" content="OpenCode terms of service" @lgcode/>
          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.<@lgcode/strong> ("OpenCode," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("@lgcode/legal@lgcode/privacy-policy")}>https:@lgcode/@lgcode/opencode.ai@lgcode/legal@lgcode/privacy-policy<@lgcode/a>.{" "}
                <strong>
                  Your use of or participation in certain Services may also be subject to additional policies, rules
                  and@lgcode/or conditions ("Additional Terms"), which are incorporated herein by reference, and you understand
              ...
              <p>
                ...
                <a href="#will-these-terms-ever-change">future changes to these Terms<@lgcode/a>,{" "}
                <a href="#recurring-billing">automatic renewals<@lgcode/a>,{" "}
                <a href="#limitation-of-liability">limitations of liability<@lgcode/a>,{" "}
                <a href="#waiver-of-class">a class action waiver<@lgcode/a> and{" "}
                <a href="#arbitration-agreement">resolution of disputes by arbitration instead of in court<@lgcode/a>.{" "}
                <strong>
              ...
              <p>
                <strong>ARBITRATION NOTICE AND CLASS ACTION WAIVER:<@lgcode/strong> EXCEPT FOR CERTAIN TYPES OF DISPUTES
                DESCRIBED IN THE <a href="#arbitration-agreement">ARBITRATION AGREEMENT SECTION BELOW<@lgcode/a>, YOU AGREE
                THAT DISPUTES BETWEEN YOU AND US WILL BE RESOLVED BY BINDING, INDIVIDUAL ARBITRATION AND YOU WAIVE YOUR
                RIGHT TO PARTICIPATE IN A CLASS ACTION LAWSUIT OR CLASS-WIDE ARBITRATION.
              <@lgcode/p>

              <h2 id="what-is-opencode">What is OpenCode?<@lgcode/h2>
              <p>
              ...
              <h2 id="will-these-terms-ever-change">Will these Terms ever change?<@lgcode/h2>
              <p>
                ...
                our site located at opencode.ai, send you an email, and@lgcode/or notify you by some other means.
              <@lgcode/p>
              ...
              <h2 id="what-about-my-privacy">What about my privacy?<@lgcode/h2>
              <p>
                OpenCode takes the privacy of its users very seriously. For the current OpenCode Privacy Policy, please
                click here{" "}
                <a href="https:@lgcode/@lgcode/opencode.ai@lgcode/legal@lgcode/privacy-policy">https:@lgcode/@lgcode/opencode.ai@lgcode/legal@lgcode/privacy-policy<@lgcode/a>.
              <@lgcode/p>

              <h3>Children's Online Privacy Protection Act<@lgcode/h3>
              <p>
                ...
                us personal information, please contact us at <a href="mailto:help@anoma.ly">help@anoma.ly<@lgcode/a>.
              <@lgcode/p>

              <h2 id="what-are-the-basics">What are the basics of using OpenCode?<@lgcode/h2>
              <p>
              ...
              <h2 id="are-there-restrictions">Are there restrictions in how I can use the Services?<@lgcode/h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <@lgcode/li>
                <li>automatically or programmatically extracts data or Output (defined below);<@lgcode/li>
                <li>Represent that the Output was human-generated when it was not;<@lgcode/li>
                <li>
                ...
                <@lgcode/li>
                <li>copies or stores any significant portion of the Content; or<@lgcode/li>
                <li>
              ...
              <h2 id="who-owns-the-services-and-content">Who Owns the Services and Content?<@lgcode/h2>
              ...
              <h2 id="what-about-third-party-models">What about Third Party Models?<@lgcode/h2>
              <p>
              ...
              <h2 id="will-opencode-ever-change-the-services">Will OpenCode ever change the Services?<@lgcode/h2>
              <p>
              ...
              <h2 id="do-the-services-cost-anything">Do the Services cost anything?<@lgcode/h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("@lgcode/zen")}>https:@lgcode/@lgcode/opencode.ai@lgcode/zen<@lgcode/a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https:@lgcode/@lgcode/stripe.com@lgcode/us@lgcode/checkout@lgcode/legal">https:@lgcode/@lgcode/stripe.com@lgcode/us@lgcode/checkout@lgcode/legal<@lgcode/a> and their
                Privacy Policy at <a href="https:@lgcode/@lgcode/stripe.com@lgcode/us@lgcode/privacy">https:@lgcode/@lgcode/stripe.com@lgcode/us@lgcode/privacy<@lgcode/a>. We are not
              ...
              <h3 id="recurring-billing">Recurring Billing<@lgcode/h3>
              <p>
                ...
                <a href="https:@lgcode/@lgcode/opencode.ai@lgcode/auth">https:@lgcode/@lgcode/opencode.ai@lgcode/auth<@lgcode/a>.
              <@lgcode/p>

              <h3>Free Trials and Other Promotions<@lgcode/h3>
              <p>
              ...
              <h2 id="what-if-i-want-to-stop">What if I want to stop using the Services?<@lgcode/h2>
              <p>
                You're free to do that at any time; please refer to our Privacy Policy{" "}
                <a href={language.route("@lgcode/legal@lgcode/privacy-policy")}>https:@lgcode/@lgcode/opencode.ai@lgcode/legal@lgcode/privacy-policy<@lgcode/a>, as well
              ...
              <h2 id="what-else-do-i-need-to-know">What else do I need to know?<@lgcode/h2>

              <h3>Warranty Disclaimer<@lgcode/h3>
              <p>
              ...
              <h3 id="limitation-of-liability">Limitation of Liability<@lgcode/h3>
              <p>
                ...
                EXCESS OF THE GREATER OF (I) ONE-HUNDRED ($100) DOLLARS OR (II) THE AMOUNTS PAID AND@lgcode/OR PAYABLE BY YOU
              ...
              <h3 id="arbitration-agreement">Arbitration Agreement<@lgcode/h3>
              <p>
              ...
              <h4>Arbitration Rules; Applicability of Arbitration Agreement<@lgcode/h4>
              <p>
              ...
              <h4>Costs of Arbitration<@lgcode/h4>
              <p>
              ...
              <h4>Small Claims Court; Infringement<@lgcode/h4>
              <p>
              ...
              <h4>Waiver of Jury Trial<@lgcode/h4>
              <p>
              ...
              <h4 id="waiver-of-class">Waiver of Class or Consolidated Actions<@lgcode/h4>
              <p>
              ...
              <p>
                ...
                your name and residence address, (ii) the email address and@lgcode/or telephone number associated with your
                account, and (iii) a clear statement that you want to opt out of these Terms' arbitration agreement.
              <@lgcode/p>

              <h4>Exclusive Venue<@lgcode/h4>
              <p>
                If you send the opt-out notice in (f), and@lgcode/or in any circumstances where the foregoing arbitration
