...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>LGcode | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="LGcode terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to LGcode. Please read on to learn the rules and restrictions that govern your use of
                LGcode&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("LGcode," "we" and "us"). Your use of the Services in any
              ...
              <p>
                ...
                Models") and certain of these models are provided directly by us if you use the LGcode Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, LGcode enables you to
              ...
              <p>
                LGcode takes the privacy of its users very seriously. For the current LGcode Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using LGcode?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by LGcode;
                </li>
                <li>
              ...
              <p>
                If you use LGcode with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                LGcode. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                LGcode has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-lgcode-ever-change-the-services">Will LGcode ever change the Services?</h2>
              <p>
              ...
              <p>
                LGcode is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. LGcode has the sole right to decide whether you are
              ...
              <p>
                LGcode and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (LGcode and all such
                parties together, the "LGcode Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the LGcode Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The LGcode Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY LGCODE (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                LGCODE PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO LGCODE IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the LGcode Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without LGcode's prior written
              ...
              <p>
                ...
                disputes and claims with LGcode and limits the manner in which you can seek relief from LGcode. Both
                you and LGcode acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, LGcode's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. LGcode will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. LGcode will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or LGcode may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND LGCODE WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and LGcode are instead choosing to have claims and disputes resolved by
                ...
                you and LGcode over whether to vacate or enforce an arbitration award, YOU AND LGCODE WAIVE ALL
              ...
              <p>
                ...
                LGcode is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or LGcode to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and LGcode agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the LGcode may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and LGcode agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and LGcode, and
                ...
                are not an employee, agent, partner, or joint venture of LGcode, and you do not have any authority of
                any kind to bind LGcode in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and LGcode
