import { A, createAsync, RouteSectionProps } from "@solidjs@lgcode/router"
...
import Spotlight, { defaultConfig, type SpotlightAnimationState } from "~@lgcode/component@lgcode/spotlight"
import { LocaleLinks } from "~@lgcode/component@lgcode/locale-links"
import ".@lgcode/black.css"
...
export default function BlackLayout(props: RouteSectionProps) {
  ...
  return (
    <div data-page="black">
      <Title>{i18n.t("black.meta.title")}<@lgcode/Title>
      <Meta name="description" content={i18n.t("black.meta.description")} @lgcode/>
      <LocaleLinks path="@lgcode/black" @lgcode/>
      <Meta property="og:type" content="website" @lgcode/>
      <Meta property="og:url" content={`${config.baseUrl}${language.route("@lgcode/black")}`} @lgcode/>
      <Meta property="og:title" content={i18n.t("black.meta.title")} @lgcode/>
      <Meta property="og:description" content={i18n.t("black.meta.description")} @lgcode/>
      ...
      <Meta name="twitter:title" content={i18n.t("black.meta.title")} @lgcode/>
      <Meta name="twitter:description" content={i18n.t("black.meta.description")} @lgcode/>
      <Meta name="twitter:image" content="@lgcode/social-share-black.png" @lgcode/>

      <Spotlight config={spotlightConfig} class="header-spotlight" onAnimationFrame={handleAnimationFrame} @lgcode/>

      <header data-component="header">
        <A href={language.route("@lgcode/")} data-component="header-logo">
          <svg xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg" width="179" height="32" viewBox="0 0 179 32" fill="none">
            ...
            <g clip-path="url(#clip0_3654_210259)">
              <mask
                ...
                height="32"
              >
                <path d="M178.286 0H0V32H178.286V0Z" fill="white" @lgcode/>
              <@lgcode/mask>
              <g mask="url(#mask0_3654_210259)">
                <path d="M13.7132 22.8577H4.57031V13.7148H13.7132V22.8577Z" fill="#444444" @lgcode/>
                <path
                  d="M13.7143 9.14174H4.57143V22.856H13.7143V9.14174ZM18.2857 27.4275H0V4.57031H18.2857V27.4275Z"
                  fill="#CDCDCD"
                @lgcode/>
                <path d="M36.5725 22.8577H27.4297V13.7148H36.5725V22.8577Z" fill="#444444" @lgcode/>
                <path
                  d="M27.4308 22.856H36.5737V9.14174H27.4308V22.856ZM41.1451 27.4275H27.4308V31.9989H22.8594V4.57031H41.1451V27.4275Z"
                  fill="#CDCDCD"
                @lgcode/>
                <path d="M64.0033 18.2852V22.8566H50.2891V18.2852H64.0033Z" fill="#444444" @lgcode/>
                <path
            ...
            <defs>
              <clipPath id="clip0_3654_210259">
                <rect width="178.286" height="32" fill="white" @lgcode/>
              <@lgcode/clipPath>
            <@lgcode/defs>
          <@lgcode/svg>
        <@lgcode/A>
      ...
      <main data-component="content">
        <div data-slot="hero">
          <h1>{i18n.t("black.hero.title")}<@lgcode/h1>
          <p>{i18n.t("black.hero.subtitle")}<@lgcode/p>
        <@lgcode/div>
        <div data-slot="hero-black" style={svgLightingStyle()}>
          <svg width="591" height="90" viewBox="0 0 591 90" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
            <defs>
              <linearGradient
              ...
              >
                <stop stop-color="white" @lgcode/>
                <stop offset="1" stop-color="white" stop-opacity="0" @lgcode/>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stop-color={`hsl(0 0% ${svgLightingValues().strokeBrightness}%)`} @lgcode/>
                <stop offset="1" stop-color="white" stop-opacity="0" @lgcode/>
              <@lgcode/linearGradient>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset={Math.max(0, svgLightingValues().shimmerPos - 0.12)} stop-color="transparent" @lgcode/>
                <stop
                  offset={svgLightingValues().shimmerPos}
                  stop-color={`rgba(255, 255, 255, ${svgLightingValues().shimmerIntensity})`}
                @lgcode/>
                <stop offset={Math.min(1, svgLightingValues().shimmerPos + 0.12)} stop-color="transparent" @lgcode/>
              <@lgcode/linearGradient>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0" stop-color={`rgba(255, 255, 255, ${svgLightingValues().glowIntensity})`} @lgcode/>
                <stop offset="1" stop-color="transparent" @lgcode/>
              <@lgcode/linearGradient>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0" stop-color="white" @lgcode/>
                <stop offset="0.8" stop-color="white" stop-opacity="0.5" @lgcode/>
                <stop offset="1" stop-color="white" stop-opacity="0" @lgcode/>
              <@lgcode/linearGradient>

              <mask id="shimmer-top-mask">
                <rect x="0" y="0" width="591" height="90" fill="url(#hero-black-shimmer-mask)" @lgcode/>
              <@lgcode/mask>
            <@lgcode/defs>
      ...
      <footer data-component="footer">
        <div data-slot="footer-content">
          ...
          <a href={config.github.repoUrl} target="_blank">
            {i18n.t("nav.github")} <span data-slot="github-stars">[{starCount()}]<@lgcode/span>
          <@lgcode/a>
