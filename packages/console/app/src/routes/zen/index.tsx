...
import zenLogoLight from "..@lgcode/..@lgcode/asset@lgcode/zen-ornate-light.svg"
import zenLogoDark from "..@lgcode/..@lgcode/asset@lgcode/zen-ornate-dark.svg"
import compareVideo from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/opencode-comparison-min.mp4"
import compareVideoPoster from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/opencode-comparison-poster.png"
import avatarDax from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/avatar-dax.png"
import avatarJay from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/avatar-jay.png"
import avatarFrank from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/avatar-frank.png"
import avatarAdam from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/avatar-adam.png"
import avatarDavid from "..@lgcode/..@lgcode/asset@lgcode/lander@lgcode/avatar-david.png"
...
import { IconGemini, IconMiniMax, IconZai } from "~@lgcode/component@lgcode/icon"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Title>{i18n.t("zen.title")}<@lgcode/Title>
      <LocaleLinks path="@lgcode/zen" @lgcode/>
      <Meta property="og:image" content="@lgcode/social-share-zen.png" @lgcode/>
      <Meta name="twitter:image" content="@lgcode/social-share-zen.png" @lgcode/>
      <Meta name="opencode:auth" content={loggedin() ? "true" : "false"} @lgcode/>

      <div data-component="container">
        <Header zen hideGetStarted @lgcode/>

        <div data-component="content">
          <section data-component="hero">
            <div data-slot="hero-copy">
              <img data-slot="zen logo light" src={zenLogoLight} alt="" @lgcode/>
              <img data-slot="zen logo dark" src={zenLogoDark} alt="" @lgcode/>
              <h1>{i18n.t("zen.hero.title")}<@lgcode/h1>
              <p>{i18n.t("zen.hero.body")}<@lgcode/p>
              <div data-slot="model-logos">
                ...
                <@lgcode/div>
                <div>
                  <IconGemini width="24" height="24" @lgcode/>
                <@lgcode/div>
                <div>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                    <path
                ...
                <@lgcode/div>
                <div>
                  <IconMiniMax width="24" height="24" @lgcode/>
                <@lgcode/div>
                <div>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                    <path
                ...
                <@lgcode/div>
                <div>
                  <IconZai width="24" height="24" @lgcode/>
                <@lgcode/div>
                <div>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                    <path
              ...
              <@lgcode/div>
              <a href="@lgcode/auth">
                <span>{i18n.t("zen.cta.start")}<@lgcode/span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http:@lgcode/@lgcode/www.w3.org@lgcode/2000@lgcode/svg">
                  <path
            ...
            <div data-slot="pricing-copy">
              <p>
                <strong>{i18n.t("zen.pricing.title")}<@lgcode/strong> <span>{i18n.t("zen.pricing.fee")}<@lgcode/span>
              <@lgcode/p>
              <p>{i18n.t("zen.pricing.body")}<@lgcode/p>
            <@lgcode/div>
          <@lgcode/section>
          ...
          <section data-component="problem">
            <div data-slot="section-title">
              <h3>{i18n.t("zen.problem.title")}<@lgcode/h3>
              <p>{i18n.t("zen.problem.body")}<@lgcode/p>
            <@lgcode/div>
            <p>{i18n.t("zen.problem.subtitle")}<@lgcode/p>
            <ul>
              <li>
                <span>[*]<@lgcode/span> {i18n.t("zen.problem.item1")}
              <@lgcode/li>
              <li>
                <span>[*]<@lgcode/span> {i18n.t("zen.problem.item2")}
              <@lgcode/li>
              <li>
                <span>[*]<@lgcode/span> {i18n.t("zen.problem.item3")}
              <@lgcode/li>
            <@lgcode/ul>
          <@lgcode/section>
          ...
          <section data-component="how">
            <div data-slot="section-title">
              <h3>{i18n.t("zen.how.title")}<@lgcode/h3>
              <p>{i18n.t("zen.how.body")}<@lgcode/p>
            <@lgcode/div>
            <ul>
              <li>
                <span>[1]<@lgcode/span>
                <div>
                  <strong>{i18n.t("zen.how.step1.title")}<@lgcode/strong> - {i18n.t("zen.how.step1.beforeLink")}{" "}
                  <a href={language.route("@lgcode/docs@lgcode/zen@lgcode/#how-it-works")} title={i18n.t("zen.how.step1.link")}>
              ...
              <li>
                <span>[2]<@lgcode/span>
                <div>
                  <strong>{i18n.t("zen.how.step2.title")}<@lgcode/strong> -{" "}
                  <a href={language.route("@lgcode/docs@lgcode/zen@lgcode/#pricing")}>{i18n.t("zen.how.step2.link")}<@lgcode/a>{" "}
              ...
              <li>
                <span>[3]<@lgcode/span>
                <div>
                  <strong>{i18n.t("zen.how.step3.title")}<@lgcode/strong> - {i18n.t("zen.how.step3.body")}
                <@lgcode/div>
              <@lgcode/li>
            <@lgcode/ul>
          <@lgcode/section>
          ...
          <section data-component="privacy">
            <div data-slot="privacy-title">
              <h3>{i18n.t("zen.privacy.title")}<@lgcode/h3>
              <div>
                <span>[*]<@lgcode/span>
                <p>
                  {i18n.t("zen.privacy.beforeExceptions")}{" "}
                  <a href={language.route("@lgcode/docs@lgcode/zen@lgcode/#privacy")}>{i18n.t("zen.privacy.exceptionsLink")}<@lgcode/a>.
                <@lgcode/p>
              <@lgcode/div>
            <@lgcode/div>
          <@lgcode/section>
          ...
          <section data-component="testimonials">
            {@lgcode/*Dax*@lgcode/}
            <a href="https:@lgcode/@lgcode/x.com@lgcode/thdxr@lgcode/status@lgcode/1973531687629017227">
              <div data-slot="testimonial">
                <div data-slot="name">
                  <img src={avatarDax} alt="" @lgcode/>
                  <strong>Dax Raad<@lgcode/strong>
                  <span>ex-CEO, Terminal Products<@lgcode/span>
                <@lgcode/div>
                <div data-slot="quote">
                  <span>@OpenCode<@lgcode/span>
                  {" Zen has been life changing, it's truly a no-brainer."}
                <@lgcode/div>
              <@lgcode/div>
            <@lgcode/a>
            {@lgcode/*Jay*@lgcode/}
            <a href="https:@lgcode/@lgcode/x.com@lgcode/jayair@lgcode/status@lgcode/1973530190870618456">
              <div data-slot="testimonial">
                <div data-slot="name">
                  <img src={avatarJay} alt="" @lgcode/>
                  <strong>Jay V<@lgcode/strong>
                  <span>ex-Founder, SEED, PM, Melt, Pop, Dapt, Cadmus, and ViewPoint<@lgcode/span>
                <@lgcode/div>
                <div data-slot="quote">
            ...
            <@lgcode/a>
            {@lgcode/*Adam*@lgcode/}
            <a href="https:@lgcode/@lgcode/x.com@lgcode/adamdotdev@lgcode/status@lgcode/1973732040718860563">
              <div data-slot="testimonial">
                <div data-slot="name">
                  <img src={avatarAdam} alt="" @lgcode/>
                  <strong>Adam Elmore<@lgcode/strong>
                  <span>ex-Hero, AWS<@lgcode/span>
                <@lgcode/div>
                <div data-slot="quote">
                  {"I can't recommend "}
                  <span>@OpenCode<@lgcode/span>
            ...
            <@lgcode/a>
            {@lgcode/*David*@lgcode/}
            <a href="https:@lgcode/@lgcode/x.com@lgcode/iamdavidhill@lgcode/status@lgcode/1973530568773214622">
              <div data-slot="testimonial">
                <div data-slot="name">
                  <img src={avatarDavid} alt="" @lgcode/>
                  <strong>David Hill<@lgcode/strong>
                  <span>ex-Head of Design, Laravel<@lgcode/span>
                <@lgcode/div>
                <div data-slot="quote">
                  {"With "}
                  <span>@OpenCode<@lgcode/span>
            ...
            <@lgcode/a>
            {@lgcode/*Frank*@lgcode/}
            <a href="https:@lgcode/@lgcode/x.com@lgcode/fanjiewang@lgcode/status@lgcode/1973530092736487756">
              <div data-slot="testimonial">
                <div data-slot="name">
                  <img src={avatarFrank} alt="" @lgcode/>
                  <strong>Frank Wang<@lgcode/strong>
                  <span>ex-Intern, Nvidia (4 times)<@lgcode/span>
                <@lgcode/div>
                <div data-slot="quote">I wish I was still at Nvidia.<@lgcode/div>
              <@lgcode/div>
            <@lgcode/a>
          <@lgcode/section>
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question={i18n.t("zen.faq.q1")}>{i18n.t("zen.faq.a1")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q2")}>{i18n.t("zen.faq.a2")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q3")}>{i18n.t("zen.faq.a3")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q4")}>
                  {i18n.t("zen.faq.a4.p1.beforePricing")}{" "}
                  <a href={language.route("@lgcode/docs@lgcode/zen@lgcode/#pricing")}>{i18n.t("zen.faq.a4.p1.pricingLink")}<@lgcode/a>{" "}
                  {i18n.t("zen.faq.a4.p1.afterPricing")} {i18n.t("zen.faq.a4.p2.beforeAccount")}{" "}
                  <a href="@lgcode/auth">{i18n.t("zen.faq.a4.p2.accountLink")}<@lgcode/a>. {i18n.t("zen.faq.a4.p3")}
                <@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q5")}>
                  {i18n.t("zen.faq.a5.beforeExceptions")}{" "}
                  <a href={language.route("@lgcode/docs@lgcode/zen@lgcode/#privacy")}>{i18n.t("zen.faq.a5.exceptionsLink")}<@lgcode/a>.
                <@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q6")}>{i18n.t("zen.faq.a6")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q7")}>{i18n.t("zen.faq.a7")}<@lgcode/Faq>
              <@lgcode/li>
              <li>
                <Faq question={i18n.t("zen.faq.q8")}>{i18n.t("zen.faq.a8")}<@lgcode/Faq>
              <@lgcode/li>
            <@lgcode/ul>
          <@lgcode/section>
