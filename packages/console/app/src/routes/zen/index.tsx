...
import compareVideo from "../../asset/lander/loongcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/loongcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="loongcode:auth" content={loggedin() ? "true" : "false"} />
