...
import compareVideo from "../../asset/lander/lgcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/lgcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="lgcode:auth" content={loggedin() ? "true" : "false"} />
