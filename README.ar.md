...
يتوفر LGcode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/opencode/releases) او من [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download).
