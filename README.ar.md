<p align="center">
  <a href="https://modelhub.lgdg.cc">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="شعار LGcode">
    </picture>
  </a>
</p>
...
يتوفر LGcode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/Clearlove7Zz/LGcode/releases) او من [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download).
...
1. `$LGCODE_INSTALL_DIR` - مجلد تثبيت مخصص
2. `$XDG_BIN_DIR` - مسار متوافق مع مواصفات XDG Base Directory
3. `$HOME/bin` - مجلد الثنائيات القياسي للمستخدم (ان وجد او امكن انشاؤه)
4. `$HOME/.lgcode/bin` - المسار الافتراضي الاحتياطي
...
يتضمن LGcode وكيليْن (Agents) مدمجين يمكنك التبديل بينهما باستخدام زر `Tab`.
...
لمزيد من المعلومات حول كيفية ضبط LGcode، [**راجع التوثيق**](https://modelhub.lgdg.cc/docs).

### المساهمة

اذا كنت مهتما بالمساهمة في LGcode، يرجى قراءة [contributing docs](./CONTRIBUTING.md) قبل ارسال pull request.
