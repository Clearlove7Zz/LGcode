...
brew install anomalyco/tap/loongcode # macOS و Linux (موصى به، دائما محدث)
...
nix run nixpkgs#loongcode           # او github:Clearlove7Zz/LGcode لاحدث فرع dev
```
...
يتوفر Loongcode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/Clearlove7Zz/LGcode/releases) او من [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download).
