...
const tableBucketName = `lgcode-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `lgcode-${$app.stage}-lake-ingest`,
    destination: "iceberg",
