...
# Package managers
npm i -g loongcode-ai@latest        # or bun/pnpm/yarn
scoop install loongcode             # Windows
choco install loongcode             # Windows
brew install anomalyco/tap/loongcode # macOS and Linux (recommended, always up to date)
...
Loongcode ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/Clearlove7Zz/LoongCode/releases) অথবা [modelhub.lgdg.cc/download](https://modelhub.lgdg.cc/download) থেকে ডাউনলোড করুন।
...
1. `$LOONGCODE_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.loongcode/bin` - ডিফল্ট ফলব্যাক
...
Loongcode এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://modelhub.lgdg.cc/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Loongcode কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://modelhub.lgdg.cc/docs)।

### অবদান (Contributing)

আপনি যদি Loongcode এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Loongcode এর উপর বিল্ডিং (Building on Loongcode)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Loongcode এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "loongcode" ব্যবহার করেন, উদাহরণস্বরূপ "loongcode-dashboard" বা "loongcode-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Loongcode দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/loongcode) | [X.com](https://x.com/loongcode)
